package com.ericorenan.workshopmongo.config;
...
import com.ericorenan.workshopmongo.dto.AuthorDTO;
import com.ericorenan.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa Viagem zé", sdf.parse("21/03/2018"), new AuthorDTO(alex));
        CommentDTO c2 = new CommentDTO("Aproveita piá", sdf.parse("22/03/2018"), new AuthorDTO(bob));
